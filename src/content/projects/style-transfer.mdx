...
This project started the way many do: I asked ChatGPT for ideas.

The prompt — and I'm quoting my actual history here — went something like:
*"give me something that can be implemented in 45 days working 5-8 hrs per week...
something to do with graphics maybe? can you think of problems that can be solved
by a certain hypothesis and needs to be experimented to confirm and get results?"*

What I got back eventually led me to neural style transfer inside a game engine.
The kind of project where you look at the scope and think "yeah, 45 days, sure."
...
Trained on Pascal VOC 2012 (~17,000 natural images) for content, with
...
The mathematical heart of style transfer is the Gram matrix — it captures
...
<YouTubeEmbed videoId="ad-yBz3aguA" title="Style Transfer Demo — Oral Presentation with Brief Demo" />
...
For a course project built in 45 days, I'll take it.